...
XCOPY /Y /Q "%OUTPUTDIR_X86%\%CORE_TASK_TEST_OUTPUT%" "%DISTDIR_X86%"
XCOPY /Y /Q "%OUTPUTDIR_X86%\%CORE_RAYTRACER_OUTPUT%" "%DISTDIR_X86%"
...
XCOPY /Y /Q "%OUTPUTDIR_X64%\%CORE_TASK_TEST_OUTPUT%" "%DISTDIR_X64%"
XCOPY /Y /Q "%OUTPUTDIR_X64%\%CORE_RAYTRACER_OUTPUT%" "%DISTDIR_X64%"
